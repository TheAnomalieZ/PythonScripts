...
np.random.seed(42)
hmm = HMMModel()
model = hmm.trainingHMM('no_big', n1)

scorelistNormal = hmm.testingHMM('normal_states1.csv',n2, 4529, model)
scorelist0 = hmm.testingHMM('anomaly3', n2, 400, model)
# print "==============================ScoreList====================================="
# print scorelist0
# print "============================================================================"
# print "=========================NormalizedScoreList================================"
...
plt.plot(percent_list,dR_list, label = 'App1')

plt.xlim(0, 100)
plt.ylim(0, 100)
plt.xlabel('Anomalous Percentage')
