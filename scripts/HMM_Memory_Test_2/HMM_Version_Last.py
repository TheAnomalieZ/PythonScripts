...
scorelist0n = testing('normal_states.csv',n2, n3)
scorelist0 = prepareData(scorelist0n, 15)
# scorelist1n = testing('anomaly_final_states1.csv',n2, n3)
# scorelist1 = prepareData(scorelist1n, 20)
scorelist2n = testing('anomaly_validation_2',n2, n3)
scorelist2 = prepareData(scorelist2n, 15)
...
# plt.plot(hstatelist,scorelist2, label = 'app1')
